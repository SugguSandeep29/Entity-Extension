class ZIN_CL_AREAHANDLE_WD_VAR definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZIN_CL_AREAHANDLE_WD_VAR' ##NO_TEXT.
  data ROOT type ref to ZIN_CL_SHMA_WEB_VARIANT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZIN_CL_AREAHANDLE_WD_VAR
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZIN_CL_SHMA_WEB_VARIANT
    raising
...
CLASS ZIN_CL_AREAHANDLE_WD_VAR IMPLEMENTATION.
