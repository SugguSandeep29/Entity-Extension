class ZIN_CL_AREAHANDLE_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZIN_CL_AREAHANDLE_AREA' ##NO_TEXT.
  data ROOT type ref to ZIN_CL_SHM_AREAHANDLE_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZIN_CL_AREAHANDLE_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZIN_CL_SHM_AREAHANDLE_ROOT
    raising
...
CLASS ZIN_CL_AREAHANDLE_AREA IMPLEMENTATION.
